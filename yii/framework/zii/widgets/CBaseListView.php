...
abstract class CBaseListView extends CWidget
{
	...
	{
		$emptyText=$this->emptyText===null ? Yii::t('zii','Sin Resultados.') : $this->emptyText;
	...
	public function renderSummary()
	{
		...
		if($this->enablePagination)
		{
			...
			if(($summaryText=$this->summaryText)===null)
				$summaryText=Yii::t('zii','Mostrando {start}-{end} de 1 resultados.|Mostrando {start}-{end} de {count} resultados.',$total);
